...
var blockElements = angular.extend({}, optionalEndTagBlockElements, makeMap("code,hljs,address,article," +
...
var svgElements = makeMap("animate,animateColor,animateMotion,animateTransform,code,circle,defs," +
...
var htmlAttrs = makeMap('data-title, code,hljs,abbr,align,alt,axis,bgcolor,border,cellpadding,cellspacing,class,clear,'+
...
var svgAttrs = makeMap('code,hljs,accent-height,accumulate,additive,alphabetic,arabic-form,ascent,' +
